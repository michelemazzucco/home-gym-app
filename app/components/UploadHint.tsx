 ...
 * dropzone; on mobile there is no gutter, so it stacks above the panel with the arrow on the
 * left, turned to point down into it.
 */
export const UploadHint = () => (
  ...
  >
    <span className="-rotate-11 font-hand text-[28px] leading-[34px] whitespace-nowrap max-lg:mb-4">
      Upload here
    </span>
    <svg
      width="30"
      ...
      viewBox="0 0 30 34"
      fill="none"
      className="mb-1 rotate-[28deg] max-lg:order-first lg:-mt-1 lg:mr-4 lg:mb-0 lg:-rotate-[22deg]"
    >
      <path
