...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        'flex h-10 w-full items-center justify-between gap-2 rounded-lg border border-border bg-ink px-3 text-base leading-5 text-chalk shadow-raised transition-colors outline-none',
