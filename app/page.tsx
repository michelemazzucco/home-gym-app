...
export default function Home() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-14 px-5 py-10 sm:px-8 lg:gap-24 lg:px-6 lg:py-20">
      <SiteHeader />
      ...
      <main className="flex flex-col gap-8 lg:gap-12">
        <div className="flex flex-wrap items-center gap-4">
          ...
          {usingMockData && (
            <span className="rounded-full border border-accent/50 bg-accent/10 px-3 py-1 text-sm text-accent">
        ...
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-x-16">
            ...
            {step === 2 && (
              <StepEquipment
                ...
                onRemove={(item) => {
                  ...
                  setSelected((prev) => prev.filter((entry) => entry !== item))
                }}
              />
            )}
          ...
          <div
            className={cn(
              'flex flex-wrap items-center gap-3 lg:col-start-1 lg:row-start-2 lg:pt-8',
          ...
          >
            ...
            {step === 2 && (
              <>
                ...
                <Button className="lg:ml-auto" onClick={generatePlan} disabled={loading}>
                  {loading ? (
                    <>
                      <Loader2 className="size-4 animate-spin" />
                      Writing the plan
